...
<!--<fmt:formatDate value="<%=new java.util.Date() %>"></fmt:formatDate>-->
\${now} : ${now}
...
patter="yyyy년 MM월 dd일 hh시 mm분 ss초" : <fmt:formatDate value="${now}" pattern="yyyy년 MM월 dd일 hh시 mm분 ss초"></fmt:formatDate>
</pre>
</body>
</html>